...
layui.define(["element", "jquery"], function(exports) {
    ...
    layuimini = new function() {
        ...
        this.init = function(url) {
            ...
            if (data == null) {
                ...
                layuimini.initUserInfo(data.userInfo);
                layuimini.initTab();
            }
            ...
            layer.close(loading);
            layer.config({
                extend: 'skin.css' //同样需要加载新皮肤
            });

        };
        this.initUserInfo = function(data) {
            $('.layuimini-setting > a').html(data.userName + '<span class="layui-nav-more"></span>');
            $(document).attr("title", data.type + " --IT类毕业实习管理系统");
            $('.menu').html('<dd><a href="javascript:;" data-iframe-tab="'+ data.child[0] +'" data-title="账户资料" data-icon="fa fa-gears">账户资料</a></dd><dd><a href="javascript:;" data-iframe-tab="'+ data.child[1] +'" data-title="修改密码" data-icon="fa fa-gears">修改密码</a></dd><dd><a href="javascript:;" class="login-out">退出登录</a></dd>');
        }
        ...
        this.initBgColor = function() {
            ...
            var styleHtml = '.layui-layout-admin .layui-header{background-color:' + bgcolorData.headerRight + '!important;}\n' +
                ...
                '}';
            window.skinStyle = bgcolorData.skin;
            // $('#layuimini-skin').html(skinStyle);
    ...
    $('body').on('click', '[data-select-bgcolor]', function() {
        ...
        parent.layuimini.msg_success("切换主题成功，下次进入系统生效");
